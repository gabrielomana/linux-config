...
sudo apt install libfdk-aac2 libldacbt-{abr,enc}2 libopenaptx0 install gstreamer1.0-pipewire libpipewire-0.3-{0,dev,modules} libspa-0.2-{bluetooth,dev,jack,modules} pipewire{,-{audio-client-libraries,pulse,bin,locales,tests}} pipewire-doc libpipewire-module-x11-bell wireplumber{,-doc} gir1.2-wp-0.4 libwireplumber-0.4-{0,dev} wireplumber-locales pipewire pipewire-audio-client-libraries pipewire-media-session-* libspa-0.2-bluetooth -y
